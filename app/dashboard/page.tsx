...
export default function Dashboard() {
  ...
  const handleSmartApply = async (job: any) => {
    ...
    try {
      console.log("Requesting AI Cover Letter...");
      ...
      console.error("Network Error during AI Gen:", e);
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex relative">
                  ...
                  <div key={i} className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm hover:border-blue-300 transition-all group">
                    ...
                    <div className="mt-6 pt-6 border-t border-slate-50 flex justify-end gap-3">
                      <button 
                        ...
                        className="flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-100 cursor-pointer"
                      >
      ...
      {/* Smart Apply Modal - FORCED TO TOP */}
      {selectedJob && selectedJob.job_title && (
        <div 
          className="fixed inset-0 flex items-center justify-center p-4 overflow-y-auto" 
          style={{ backgroundColor: 'rgba(15, 23, 42, 0.9)', backdropFilter: 'blur(8px)', zIndex: 99999 }}
        >
          <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl my-auto relative z-[100000]">
            ...
            <div className="p-8 space-y-8 max-h-[60vh] overflow-y-auto">
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  <Clock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-
